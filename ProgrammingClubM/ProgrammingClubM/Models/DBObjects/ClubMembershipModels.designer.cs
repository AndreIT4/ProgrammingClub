...
namespace ProgrammingClubM.Models.DBObjects
{
	...
	public partial class CodeSnippet : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<System.Guid> _IDSnippetPreviousVersion;
		...
		private EntityRef<CodeSnippet> _CodeSnippet1;
    ...
    partial void OnIDSnippetPreviousVersionChanging(System.Nullable<System.Guid> value);
    partial void OnIDSnippetPreviousVersionChanged();
    ...
    partial void OnIsPublishedChanged();
		...
		public CodeSnippet()
		{
			...
			this._CodeSnippet1 = default(EntityRef<CodeSnippet>);
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_IDSnippetPreviousVersion", DbType="UniqueIdentifier")]
		public System.Nullable<System.Guid> IDSnippetPreviousVersion
		{
			get
			{
				return this._IDSnippetPreviousVersion;
			}
			set
			{
				if ((this._IDSnippetPreviousVersion != value))
				{
					if (this._CodeSnippet1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
					this.OnIDSnippetPreviousVersionChanging(value);
					this.SendPropertyChanging();
					this._IDSnippetPreviousVersion = value;
					this.SendPropertyChanged("IDSnippetPreviousVersion");
					this.OnIDSnippetPreviousVersionChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CodeSnippet_CodeSnippet", Storage="_CodeSnippets", ThisKey="IDCodeSnippet", OtherKey="IDSnippetPreviousVersion")]
		...
		[global::System.Data.Linq.Mapping.AssociationAttribute(Name="CodeSnippet_CodeSnippet", Storage="_CodeSnippet1", ThisKey="IDSnippetPreviousVersion", OtherKey="IDCodeSnippet", IsForeignKey=true)]
		public CodeSnippet CodeSnippet1
		{
			get
			{
				return this._CodeSnippet1.Entity;
			}
			set
			{
				CodeSnippet previousValue = this._CodeSnippet1.Entity;
				if (((previousValue != value) 
							|| (this._CodeSnippet1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._CodeSnippet1.Entity = null;
						previousValue.CodeSnippets.Remove(this);
					}
					this._CodeSnippet1.Entity = value;
					if ((value != null))
					{
						value.CodeSnippets.Add(this);
						this._IDSnippetPreviousVersion = value.IDCodeSnippet;
					}
					else
					{
						this._IDSnippetPreviousVersion = default(Nullable<System.Guid>);
					}
					this.SendPropertyChanged("CodeSnippet1");
				}
			}
		}
